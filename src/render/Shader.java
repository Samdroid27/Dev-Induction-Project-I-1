...
public class Shader 
{
	...
	private int vertexShaderObject;//vertex shader processes all vertices
	private int fragmentShaderObject;//fragment shader gives color,blurring etc
    ...
    public Shader(String filename)
    {
        ...
        {
            System.err.println(glGetShaderInfoLog(vertexShaderObject));   //getting error
            System.exit(1);
        }
        ...
        {
            System.err.println(glGetShaderInfoLog(fragmentShaderObject));   //getting error
            System.exit(1);
        }
        ...
        {
            System.err.println(glGetProgramInfoLog(vertexShaderObject));   //getting error
            System.exit(1);
        }
